...
const className = "JavaScript Fundamentals"; // declared a const because its a set value.
const passingScore = 60; // declared a const because it is the minimum value students need to pass.
let studentNames = ["Alex", "Zoe", "David", "Bob", "Greta", "Alice"]; // let value because students change classes.
const studentScores = [74, 58, 92, 65, 81, 47]; // const because these are the grades the students received.
...
console.log("Third students score: " + studentScores[2]);
...
console.log("Students saved by the curve: " + curveSavedCount);
