...
// What's wrong ↓
// There is a return value expected but return was never called
// Your fix ↓
const prices = [29.99, 49.99, 14.99, 99.99];
...
// What's wrong ↓
// instead of checking the order status === which is check for the exact value its using =.
// Your fix ↓
const orders = [
  { id: 1, status: "delivered" },
  { id: 2, status: "pending"   },
...
// Bug 1 ↓
// there was no inital value set. With reduce you should always start with 0.
// Bug 2 ↓
