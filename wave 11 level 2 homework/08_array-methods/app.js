...
console.log("Missing: " + missingOrder);
// when nothing matches returns undefined.
...
// Prediction: True
const hasExpensiveOrder = orders.some(function (order) {
  return order.total > 300;
});

console.log("Has $300+ order: " + hasExpensiveOrder);
...
console.log("All priority multi-item: " + allPriority);
...
const totalItems = orders.reduceRight(function (acc, order) {
